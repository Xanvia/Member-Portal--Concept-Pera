      ...
      <div className="h-full p-10">
        <div className="g-6 flex h-full flex-wrap items-center justify-center text-neutral-100 dark:text-neutral-200">
          <div className="w-full">
            <div className="block rounded-lg bg-blue-950 shadow-lg dark:bg-neutral-800">
              <div className="g-0 md:flex lg:flex-wrap">
                ...
                <div className="px-4 md:px-0 lg:w-6/12">
                  <div className="md:mx-6 md:p-12">
                    ...
                    <div className="text-center">
                      ...
                      <h4
                        className={
                          "mb-12 mt-1 pb-1 text-2xl " + exo_2.className
                        }
                      >
                        Concept Pera
                      </h4>
                ...
                <div
                  ...
                  style={{
                    background: "linear-gradient(to right, #172554 , #eead0e)",
                  }}
                >
